...
Route::get('/search','SearchTaskController@index')->name('search'); 

Route::post('/searchByTitle','SearchTaskController@search')->name('searchByTitle'); 

Route::get('/searchByTitle','SearchTaskController@index')->name('searchByTitle'); 
